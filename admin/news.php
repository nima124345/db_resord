...
<html lang="en">
  <head>
    ...
    <!-- =======================================================
    * Template Name: Nicenews
    * Updated: Mar 09 2023 with Bootstrap v5.2.3
    * Template URL: https://bootstrapmade.com/nice-news-bootstrap-news-html-template/
  ...
  <body>
    ...
    <main id="main" class="main">
      <div class="pagetitle">
        <h1><font face="TH Sarabun New" size="7">จัดการข่าวสาร</font></h1>
        </div><!-- End Page Title -->
            ...
            <div class="col-lg-12">
              <div class="card">
                ...
                $act = (isset($_GET['act']) ? $_GET['act'] : '');
                 if(empty($act)){ ?>
                  <div class="card-title"><font face="TH Sarabun New" size="5">ตารางข้อมูลข่าวสาร</font>
                      <a href="news.php?act=add"  class="btn btn-primary btn-sm"> 
                      +เพิ่มข้อมูล</a>
                  </div>
                <?php } ?>
