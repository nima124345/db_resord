...
<html lang="en">
  ...
  <body>
    ...
    <main id="main" class="main">
      <div class="pagetitle">
        <h1><font face="TH Sarabun New" size="6">รายงาน</font>
        <a href="index.php" class="btn btn-success btn-sm">ข้อมูลการจองแยกตามสถานะ</a>
          <a href="index.php?act=booking" class="btn btn-info btn-sm">รายงานการจอง</a>
          <a href="index.php?act=allProfit" class="btn btn-primary btn-sm">รายงานรายได้ทั้งหมด</a>
        </h1>
        </div><!-- End Page Title -->
