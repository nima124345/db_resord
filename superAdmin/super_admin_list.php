...
?>                <table class="table datatable table-striped table-bordered table-sm">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            <?php if($row_result["admin_show"] == 1){
                              echo 'Active';
                            }else{
                              echo 'ระงับ';
                            }
                           ...
                           <td><center>
                            <a href="super_admin.php?act=edit&admin_id=<?php echo $row_result["admin_id"];?>" class="btn btn-warning btn-sm">
                          <i class="ri-edit-box-fill"> </i>
                            <font face="TH Sarabun New" > แก้ไข </font></a> 
                          </center>
                        </td>
                          <td><center>
                            <a type="button" class="btn btn-danger btn-sm" href="JavaScript:if(confirm('คุณแน่ใจที่จะลบข้อมูลนี้?') == true){window.location='super_admin.php?admin_id=<?php echo $row_result["admin_id"];?>&act=del';}">
