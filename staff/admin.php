...
<html lang="en">
  ...
  <body>
    ...
    <main id="main" class="main">
      <div class="pagetitle">
        <h1><font face="TH Sarabun New" size="7">จัดการสิทธิ์ผู้ใช้งาน</font></h1>
        </div><!-- End Page Title -->
            ...
            <div class="col-lg-12">
              ...
              <?php
                $act = (isset($_GET['act']) ? $_GET['act'] : '');
                 if(empty($act)){ ?>
                  <div class="card-title"><font face="TH Sarabun New" size="5">ตารางข้อมูล Amin/Staff</font>
                      <a href="admin.php?act=add"  class="btn btn-primary btn-sm"> 
                      +เพิ่มข้อมูล</a>
