...
<div class="row">
  ...
  <div class="col-sm-4" id="hid">
    <br>
    <font face="TH Sarabun New" size="5">ฟอร์มตรวจสอบการชำระเงิน</font>
    <hr>
    <form action="bookingStatusUpdate.php" method="post">
      <div class="row mb-2">
        ...
        <select name="booking_status" class="form-control" required>
          <option value="4">-การชำระเงินถูกต้อง</option>
          <option value="2">-การชำระเงินไม่ถูกต้อง</option>
        </select>
      </div>
      
      <div class="row">
        <input type="hidden" name="booking_id" value="<?=$rwbD['booking_id'];?>">
        <button type="submit" name="act" value="payment" class="btn btn-primary">บันทึกตรวจสอบการชำระเงิน</button>
      </div>
    </form>
  </div>
</div>
