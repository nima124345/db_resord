...
AND  b.payDate BETWEEN '$ds' AND '$de'
...
<form action="report.php" method="get">
  <div class="row">
    ...
    <div class="col-sm-3">
      <input type="date" name="ds" class="form-control" required  value="<?=$_GET['ds'];?>">
    </div>
     <label class="col-sm-1">ถึง</label>
    <div class="col-sm-3">
      <input type="date" name="de" class="form-control" required value="<?=$_GET['de'];?>">
    </div>
    <div class="col-sm-3">
...
<h5>วันที่เรียกดูข้อมูล <?=date('d/m/Y',strtotime($_GET['ds']));?> - <?=date('d/m/Y',strtotime($_GET['de']));?></h5>
