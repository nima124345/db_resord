<?php
$sql_script = "SELECT DATE_FORMAT(payDate, '%M-%Y') as bookingM,
SUM(booking_amount) totalbyM 
FROM tb_booking
...
<table class="table  table-striped table-bordered table-sm">
  ...
  <tbody>
    ...
    $total += $row_result["totalbyM"];  ?>
    <tr>
      <td scope="row"> <font face="TH Sarabun New"><?php echo $row_result["bookingM"];?></font></td>
      <td align="right"><font face="TH Sarabun New"><?php echo number_format($row_result["totalbyM"],2);?></font></td>
