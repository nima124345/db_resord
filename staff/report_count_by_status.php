...
<table class="table table-hover table-striped table-bordered table-sm">
	<thead>
		<tr class="table-info">
			...
			<th width="10%" class="text-center">เปิดดู</th>
		</tr>
	</thead>
	<tbody>
		<tr>
			...
			<td align="center"><a href="booking.php" class="btn btn-info btn-sm">เปิดดู</a></td>
		</tr>
		<tr>
			<td align="center">2</td>
			<td>ชำระเงินแล้ว *รอตรวจสอบการชำระเงิน</td>
			<td align="center"><?php echo $rwst3['totals3'];?></td>
			<td align="center"><a href="booking.php?act=paid" class="btn btn-info btn-sm">เปิดดู</a></td>
		</tr>
		<tr>
			<td align="center">3</td>
			<td>*ตรวจสอบการชำระเงินสำเร็จ รอเข้าพัก</td>
			<td align="center"><?php echo $rwst4['totals4'];?></td>
			<td align="center"><a href="booking.php?act=wait" class="btn btn-info btn-sm">เปิดดู</a></td>
		</tr>
		<tr>
			<td align="center">4</td>
			<td>Check IN - เข้าพัก</td>
			<td align="center"><?php echo $rwst5['totals5'];?></td>
			<td align="center"><a href="booking.php?act=chkIN" class="btn btn-info btn-sm">เปิดดู</a></td>
		</tr>
		<tr>
			<td align="center">5</td>
			<td>Check OUT - สำเร็จ</td>
			<td align="center"><?php echo $rwst1['totals1'];?></td>
			<td align="center"><a href="booking.php?act=chkOut" class="btn btn-info btn-sm">เปิดดู</a></td>
		</tr>
		<tr>
			<td align="center">6</td>
			<td>รายการยกเลิก</td>
			<td align="center"><?php echo $rwst0['totals0'];?></td>
			<td align="center"><a href="booking.php?act=cancle" class="btn btn-info btn-sm">เปิดดู</a></td>
		</tr>
	</tbody>
</table>