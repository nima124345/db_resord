...
?>
<br> 
<font face="TH Sarabun New" >ข้อมูลการจอง *ตรวจสอบการชำระเงินสำเร็จ รอเข้าพัก</font>
  ...
  <?php  foreach ($result as $row_result) {  ?>
    <tr>
      ...
      <td><?php echo $row_result["room_number"];?></td>
       ...
       <td><?php echo date('d/m/Y', strtotime($row_result["checkInDate"]));?>  - <?php echo date('d/m/Y', strtotime($row_result["checkOutDate"]));?> <br>
        <font color="red">
      ...
      <td><center>
        <a href="booking.php?act=checkIN&booking_id=<?php echo $row_result["booking_id"];?>" class="btn btn-info btn-sm">
          <i class="ri-edit-box-fill"> </i>
        <font face="TH Sarabun New" > Check-In </font></a>
        </center>
      </td>
