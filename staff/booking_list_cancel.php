...
?>
<br>
<font face="TH Sarabun New" >รายการยกเลิก</font>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><?php echo $row_result["room_number"];?></td>
       ...
       <td>
        <?php echo date('d/m/Y', strtotime($row_result["checkInDate"]));?>  - <?php echo date('d/m/Y', strtotime($row_result["checkOutDate"]));?>
          <br>
          <font color="red">
              เหตุผลที่ถูกยกเลิก.<?php echo $row_result["remark"];?>
          </font>
        </td>
      ...
      <td><center>
        <a href="booking.php?act=view2&booking_id=<?php echo $row_result["booking_id"];?>" class="btn btn-info btn-sm">
          <i class="ri-edit-box-fill"> </i>
        <font face="TH Sarabun New" > รายละเอียด </font></a>
        </center>
      </td>
