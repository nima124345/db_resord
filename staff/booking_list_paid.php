...
?>
<br> 
<font face="TH Sarabun New" >ข้อมูลการจอง *รอตรวจสอบการชำระเงิน</font>
<table class="table datatable table-striped table-bordered table-sm">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><center>
        <a href="booking.php?act=viewPaid&booking_id=<?php echo $row_result["booking_id"];?>" class="btn btn-info btn-sm">
          <i class="ri-edit-box-fill"> </i>
        <font face="TH Sarabun New" > ตรวจสอบการชำระเงิน </font></a>
        </center>
      </td>
